...
import {ConfigWithOptionalStyle, ImageButton, MarkerLane, MarkerLaneConfig} from '@byomakase/omakase-player';
import {Constants} from '../../../../constants/constants';

export class TelemetryMarkerLane extends MarkerLane {
