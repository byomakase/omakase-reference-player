...
import {ConfigWithOptionalStyle, ImageButton, OgChartLane, OgChartLaneConfig} from '@byomakase/omakase-player';
import {Constants} from '../../../../constants/constants';

export class TelemetryOgChartLane extends OgChartLane {
